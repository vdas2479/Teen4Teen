...
// Seeker submits the Help tab form (public)
...
// Admin: get automated match suggestions for one request
...
// Admin: approve a match (automated suggestion OR manual override)
router.post("/:id/match", async (req, res) => {
  ...
  // In production: trigger an automated email to the matched volunteer here.
