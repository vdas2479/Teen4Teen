...
const PLATFORM_ICONS = {
  instagram_url: ICONS.instagram,
  tiktok_url: ICONS.tiktok,
  discord_url: ICONS.discord,
  youtube_url: ICONS.youtube,
};

export default function Footer() {
  const { settings } = useSiteSettings();

  const socials = ["instagram_url", "tiktok_url", "discord_url", "youtube_url"]
    .filter(key => settings[key])
    .map(key => ({ label: PLATFORM_LABELS[key], url: settings[key], icon: PLATFORM_ICONS[key] }));
